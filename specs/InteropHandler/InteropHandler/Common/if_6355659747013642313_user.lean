...
import generated.InteropHandler.InteropHandler.Common.if_6355659747013642313_gen
...
* Guard `split_expr_1` zero  ⇒ the block REVERTS: the result is the initial state with
  its EVM replaced by `evm_revert evm 0 0`, so `s₉.evm.reverted = true`.
* Guard `split_expr_1` nonzero ⇒ the block is a no-op: `s₉ = s₀`.

Self-contained: does not mention `if_6355659747013642313_concrete_of_code`, so the bridge
