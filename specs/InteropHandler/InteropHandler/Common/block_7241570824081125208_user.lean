...
import generated.InteropHandler.InteropHandler.Common.block_7241570824081125208_gen
...
def A_block_7241570824081125208 (s₀ s₉ : State) : Prop :=
  block_7241570824081125208_concrete_of_code.1 s₀ s₉
