...
import generated.InteropHandler.InteropHandler.Common.block_1324250930592083263_gen
...
Abstract spec for the Yul block
    ...
    {
      mstore(split_expr_26, split_expr_27)
      let split_expr_28 := add(_7, 36)
      mstore(split_expr_28, _6)
      let split_expr_29 := add(_7, 68)
      mstore(split_expr_29, _2)
    }
...
Self-contained: does not mention `block_1324250930592083263_concrete_of_code`.
-/
def A_block_1324250930592083263 (s₀ s₉ : State) : Prop :=
  s₉ = (((s₀⟦"split_expr_28" ↦ (s₀["_7"]!!) + (36 : UInt256)⟧)⟦"split_expr_29" ↦ (s₀["_7"]!!) + (68 : UInt256)⟧)🇪⟦(((s₀.evm.mstore (s₀["split_expr_26"]!!) (s₀["split_expr_27"]!!)).mstore ((s₀["_7"]!!) + (36 : UInt256)) (s₀["_6"]!!)).mstore ((s₀["_7"]!!) + (68 : UInt256)) (s₀["_2"]!!))⟧)

lemma block_1324250930592083263_abs_of_concrete {s₀ s₉ : State} :
  Spec block_1324250930592083263_concrete_of_code s₀ s₉ →
  Spec A_block_1324250930592083263 s₀ s₉ := by
  unfold block_1324250930592083263_concrete_of_code A_block_1324250930592083263
