...
import generated.InteropHandler.InteropHandler.Common.block_7778734710101628289_gen
...
Abstract spec for the Yul block
    ...
    {
      let split_expr_55 := add(_7, 192)
      let offset_2 := mload(split_expr_55)
    }
...
Self-contained: does not mention `block_7778734710101628289_concrete_of_code`.
-/
def A_block_7778734710101628289 (s₀ s₉ : State) : Prop :=
  s₉ = ((s₀⟦"split_expr_55" ↦ (s₀["_7"]!!) + (192 : UInt256)⟧)⟦"offset_2" ↦ (s₀.evm.mload ((s₀["_7"]!!) + (192 : UInt256)))⟧)

lemma block_7778734710101628289_abs_of_concrete {s₀ s₉ : State} :
  Spec block_7778734710101628289_concrete_of_code s₀ s₉ →
  Spec A_block_7778734710101628289 s₀ s₉ := by
  unfold block_7778734710101628289_concrete_of_code A_block_7778734710101628289
