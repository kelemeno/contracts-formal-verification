...
Abstract spec for the Yul block
    ...
    {
      let split_expr_24 := mload(split_expr_23)
      mstore(split_expr_22, split_expr_24)
      let split_expr_25 := add(memPtr_2, 128)
      let split_expr_26 := add(_3, 160)
      let split_expr_27 := mload(split_expr_26)
    }
...
Self-contained: does not mention `block_4886309943594890699_concrete_of_code`.
-/
def A_block_4886309943594890699 (s₀ s₉ : State) : Prop :=
  s₉ = (((((s₀⟦"split_expr_24" ↦ (s₀.evm.mload (s₀["split_expr_23"]!!))⟧)⟦"split_expr_25" ↦ (s₀["memPtr_2"]!!) + (128 : UInt256)⟧)⟦"split_expr_26" ↦ (s₀["_3"]!!) + (160 : UInt256)⟧)⟦"split_expr_27" ↦ ((s₀.evm.mstore (s₀["split_expr_22"]!!) (s₀.evm.mload (s₀["split_expr_23"]!!))).mload ((s₀["_3"]!!) + (160 : UInt256)))⟧)🇪⟦(s₀.evm.mstore (s₀["split_expr_22"]!!) (s₀.evm.mload (s₀["split_expr_23"]!!)))⟧)
...
lemma block_4886309943594890699_abs_of_concrete {s₀ s₉ : State} :
  ...
  unfold block_4886309943594890699_concrete_of_code A_block_4886309943594890699
