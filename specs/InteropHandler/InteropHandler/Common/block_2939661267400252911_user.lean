...
import generated.InteropHandler.InteropHandler.Common.block_2939661267400252911_gen
...
Abstract spec for the Yul block
    ...
    {
      let split_expr_8 := add(value, 64)
      let memberValue0 := mload(split_expr_8)
      let split_expr_9 := add(pos, 64)
      mstore(split_expr_9, 96)
      let split_expr_10 := add(pos, 96)
    }
...
Self-contained: does not mention `block_2939661267400252911_concrete_of_code`.
-/
def A_block_2939661267400252911 (s₀ s₉ : State) : Prop :=
  s₉ = (((((s₀⟦"split_expr_8" ↦ (s₀["value"]!!) + (64 : UInt256)⟧)⟦"memberValue0" ↦ (s₀.evm.mload ((s₀["value"]!!) + (64 : UInt256)))⟧)⟦"split_expr_9" ↦ (s₀["pos"]!!) + (64 : UInt256)⟧)⟦"split_expr_10" ↦ (s₀["pos"]!!) + (96 : UInt256)⟧)🇪⟦(s₀.evm.mstore ((s₀["pos"]!!) + (64 : UInt256)) (96 : UInt256))⟧)
...
lemma block_2939661267400252911_abs_of_concrete {s₀ s₉ : State} :
  ...
  unfold block_2939661267400252911_concrete_of_code A_block_2939661267400252911
