...
import generated.InteropHandler.InteropHandler.Common.block_782471337718906065_gen
...
def A_block_782471337718906065 (s₀ s₉ : State) : Prop := sorry

lemma block_782471337718906065_abs_of_concrete {s₀ s₉ : State} :
  Spec block_782471337718906065_concrete_of_code s₀ s₉ →
  Spec A_block_782471337718906065 s₀ s₉ := by
  sorry
