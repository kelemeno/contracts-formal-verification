...
import generated.InteropHandler.InteropHandler.Common.block_7884142616618953877_gen
...
def A_block_7884142616618953877 (s₀ s₉ : State) : Prop := sorry

lemma block_7884142616618953877_abs_of_concrete {s₀ s₉ : State} :
  Spec block_7884142616618953877_concrete_of_code s₀ s₉ →
  Spec A_block_7884142616618953877 s₀ s₉ := by
  sorry
