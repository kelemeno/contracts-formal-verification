...
Abstract spec for the Yul block
    ...
    {
      let split_expr_11 := mload(_1)
      let length_3 := mload(split_expr_11)
      let var_i_1 := 0
    }
...
Self-contained: does not mention `block_4597829123177901218_concrete_of_code`.
-/
def A_block_4597829123177901218 (s₀ s₉ : State) : Prop :=
  s₉ = (((s₀⟦"split_expr_11" ↦ (s₀.evm.mload (s₀["_1"]!!))⟧)⟦"length_3" ↦ (s₀.evm.mload (s₀.evm.mload (s₀["_1"]!!)))⟧)⟦"var_i_1" ↦ (0 : UInt256)⟧)
...
lemma block_4597829123177901218_abs_of_concrete {s₀ s₉ : State} :
  ...
  unfold block_4597829123177901218_concrete_of_code A_block_4597829123177901218
