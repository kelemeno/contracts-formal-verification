...
import generated.InteropHandler.InteropHandler.abi_decode_bytes1_fromMemory_gen
...
def A_abi_decode_bytes1_fromMemory (value : Identifier) (offset : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma abi_decode_bytes1_fromMemory_abs_of_concrete {s₀ s₉ : State} {value offset} :
  ...
  unfold abi_decode_bytes1_fromMemory_concrete_of_code A_abi_decode_bytes1_fromMemory
  sorry
