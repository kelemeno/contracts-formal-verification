...
def A_fun_parseEvmV1 (var_chainId var_addr : Identifier) (var_self_mpos : Literal) (s₀ s₉ : State) : Prop :=
  fun_parseEvmV1_concrete_of_code.1 var_chainId var_addr var_self_mpos s₀ s₉
