...
import generated.L2AssetRouter.L2AssetRouter.abi_encode_uint256_gen
...
def A_abi_encode_uint256 (tail : Identifier) (headStart value0 : Literal) (s₀ s₉ : State) : Prop := abi_encode_uint256_concrete_of_code.1 tail headStart value0 s₀ s₉
