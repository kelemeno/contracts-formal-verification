...
def A_memory_array_index_access_bytes_dyn (addr : Identifier) (baseRef : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma memory_array_index_access_bytes_dyn_abs_of_concrete {s₀ s₉ : State} {addr baseRef} :
  ...
  unfold memory_array_index_access_bytes_dyn_concrete_of_code A_memory_array_index_access_bytes_dyn
  sorry
