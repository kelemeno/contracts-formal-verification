...
def A_require_helper_error_InvalidSelector_bytes4  (condition expr : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma require_helper_error_InvalidSelector_bytes4_abs_of_concrete {s₀ s₉ : State} { condition expr} :
  ...
  unfold require_helper_error_InvalidSelector_bytes4_concrete_of_code A_require_helper_error_InvalidSelector_bytes4
  sorry
