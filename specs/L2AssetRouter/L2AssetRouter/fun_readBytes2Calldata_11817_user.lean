...
def A_fun_readBytes2Calldata_11817 (var_value : Identifier) (var_buffer_offset : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma fun_readBytes2Calldata_11817_abs_of_concrete {s₀ s₉ : State} {var_value var_buffer_offset} :
  ...
  unfold fun_readBytes2Calldata_11817_concrete_of_code A_fun_readBytes2Calldata_11817
  sorry
