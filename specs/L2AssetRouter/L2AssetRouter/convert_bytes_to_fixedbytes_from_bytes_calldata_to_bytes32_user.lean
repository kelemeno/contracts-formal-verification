...
def A_convert_bytes_to_fixedbytes_from_bytes_calldata_to_bytes32 (value : Identifier) (array len : Literal) (s₀ s₉ : State) : Prop := convert_bytes_to_fixedbytes_from_bytes_calldata_to_bytes32_concrete_of_code.1 value array len s₀ s₉
...
lemma convert_bytes_to_fixedbytes_from_bytes_calldata_to_bytes32_abs_of_concrete {s₀ s₉ : State} {value array len} :
  ...
  intro h
  simpa [A_convert_bytes_to_fixedbytes_from_bytes_calldata_to_bytes32] using h
