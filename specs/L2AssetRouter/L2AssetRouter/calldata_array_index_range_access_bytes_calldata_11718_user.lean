...
def A_calldata_array_index_range_access_bytes_calldata_11718 (offsetOut lengthOut : Identifier) (offset length : Literal) (s₀ s₉ : State) : Prop := calldata_array_index_range_access_bytes_calldata_11718_concrete_of_code.1 offsetOut lengthOut offset length s₀ s₉
...
lemma calldata_array_index_range_access_bytes_calldata_11718_abs_of_concrete {s₀ s₉ : State} {offsetOut lengthOut offset length} :
  ...
  intro h
  simpa [A_calldata_array_index_range_access_bytes_calldata_11718] using h
