...
def A_abi_encode_bytes32_bytes (tail : Identifier) (headStart value0 value1 : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma abi_encode_bytes32_bytes_abs_of_concrete {s₀ s₉ : State} {tail headStart value0 value1} :
  ...
  unfold abi_encode_bytes32_bytes_concrete_of_code A_abi_encode_bytes32_bytes
  sorry
