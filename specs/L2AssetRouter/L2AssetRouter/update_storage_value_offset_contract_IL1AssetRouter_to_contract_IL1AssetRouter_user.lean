...
def A_update_storage_value_offset_contract_IL1AssetRouter_to_contract_IL1AssetRouter  (slot value : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma update_storage_value_offset_contract_IL1AssetRouter_to_contract_IL1AssetRouter_abs_of_concrete {s₀ s₉ : State} { slot value} :
  ...
  unfold update_storage_value_offset_contract_IL1AssetRouter_to_contract_IL1AssetRouter_concrete_of_code A_update_storage_value_offset_contract_IL1AssetRouter_to_contract_IL1AssetRouter
  sorry
