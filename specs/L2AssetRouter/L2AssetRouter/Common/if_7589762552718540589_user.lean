...
import generated.L2AssetRouter.L2AssetRouter.Common.if_7589762552718540589_gen
...
def A_if_7589762552718540589 (s₀ s₉ : State) : Prop := if_7589762552718540589_concrete_of_code.1 s₀ s₉
