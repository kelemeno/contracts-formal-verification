...
import generated.L2AssetRouter.L2AssetRouter.Common.if_508989492593568173_gen
...
def A_if_508989492593568173 (s₀ s₉ : State) : Prop := if_508989492593568173_concrete_of_code.1 s₀ s₉
