...
import generated.L2AssetRouter.L2AssetRouter.Common.if_1636797331660012289_gen
...
def A_if_1636797331660012289 (s₀ s₉ : State) : Prop := if_1636797331660012289_concrete_of_code.1 s₀ s₉
