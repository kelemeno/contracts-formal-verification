...
def A_read_from_storage_split_offset_address_11714 (value : Identifier)  (s₀ s₉ : State) : Prop := read_from_storage_split_offset_address_11714_concrete_of_code.1 value s₀ s₉
...
lemma read_from_storage_split_offset_address_11714_abs_of_concrete {s₀ s₉ : State} {value } :
  ...
  intro h
  simpa [A_read_from_storage_split_offset_address_11714] using h
