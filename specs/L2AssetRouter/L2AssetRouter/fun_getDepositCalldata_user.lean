...
def A_fun_getDepositCalldata (var_1373_mpos : Identifier) (var_assetId var_assetData_mpos : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma fun_getDepositCalldata_abs_of_concrete {s₀ s₉ : State} {var_1373_mpos var_assetId var_assetData_mpos} :
  ...
  unfold fun_getDepositCalldata_concrete_of_code A_fun_getDepositCalldata
  sorry
