...
def A_abi_decode_uint256t_bytes32t_bytes (value0 value1 value2 : Identifier) (headStart dataEnd : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma abi_decode_uint256t_bytes32t_bytes_abs_of_concrete {s₀ s₉ : State} {value0 value1 value2 headStart dataEnd} :
  ...
  unfold abi_decode_uint256t_bytes32t_bytes_concrete_of_code A_abi_decode_uint256t_bytes32t_bytes
  sorry
