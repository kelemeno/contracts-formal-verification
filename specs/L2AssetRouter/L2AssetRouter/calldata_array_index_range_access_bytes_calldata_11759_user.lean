...
def A_calldata_array_index_range_access_bytes_calldata_11759 (offsetOut lengthOut : Identifier) (offset length endIndex : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma calldata_array_index_range_access_bytes_calldata_11759_abs_of_concrete {s₀ s₉ : State} {offsetOut lengthOut offset length endIndex} :
  ...
  unfold calldata_array_index_range_access_bytes_calldata_11759_concrete_of_code A_calldata_array_index_range_access_bytes_calldata_11759
  sorry
