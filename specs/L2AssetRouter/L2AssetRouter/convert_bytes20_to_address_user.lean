...
def A_convert_bytes20_to_address (converted : Identifier) (value : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma convert_bytes20_to_address_abs_of_concrete {s₀ s₉ : State} {converted value} :
  ...
  unfold convert_bytes20_to_address_concrete_of_code A_convert_bytes20_to_address
  sorry
