...
def A_calldata_array_index_access_bytes_calldata_11818 (addr : Identifier) (base_ref length : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma calldata_array_index_access_bytes_calldata_11818_abs_of_concrete {s₀ s₉ : State} {addr base_ref length} :
  ...
  unfold calldata_array_index_access_bytes_calldata_11818_concrete_of_code A_calldata_array_index_access_bytes_calldata_11818
  sorry
