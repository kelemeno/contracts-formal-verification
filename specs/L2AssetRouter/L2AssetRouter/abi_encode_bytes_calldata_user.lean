...
def A_abi_encode_bytes_calldata (tail : Identifier) (headStart value0 value1 : Literal) (s₀ s₉ : State) : Prop := abi_encode_bytes_calldata_concrete_of_code.1 tail headStart value0 value1 s₀ s₉
