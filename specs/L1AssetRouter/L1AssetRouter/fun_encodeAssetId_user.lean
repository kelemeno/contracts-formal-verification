...
def A_fun_encodeAssetId (var : Identifier) (var_chainId var_assetData var_sender : Literal) (s₀ s₉ : State) : Prop := fun_encodeAssetId_concrete_of_code.1 var var_chainId var_assetData var_sender s₀ s₉
