...
def A_abi_encode_array_bytes32_dyn_calldata (end_clear_sanitised_hrafn : Identifier) (start length pos : Literal) (s₀ s₉ : State) : Prop := True
...
lemma abi_encode_array_bytes32_dyn_calldata_abs_of_concrete {s₀ s₉ : State} {end_clear_sanitised_hrafn start length pos} :
  ...
  unfold A_abi_encode_array_bytes32_dyn_calldata
