...
import generated.L1AssetRouter.L1AssetRouter.Common.if_5064767104898712986_gen
...
def A_if_5064767104898712986 (s₀ s₉ : State) : Prop :=
  if_5064767104898712986_concrete_of_code.1 s₀ s₉
