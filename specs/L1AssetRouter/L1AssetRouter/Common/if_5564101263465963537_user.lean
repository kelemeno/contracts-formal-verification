...
import generated.L1AssetRouter.L1AssetRouter.Common.if_5564101263465963537_gen
...
def A_if_5564101263465963537 (s₀ s₉ : State) : Prop :=
  if_5564101263465963537_concrete_of_code.1 s₀ s₉
