...
import generated.L1AssetRouter.L1AssetRouter.Common.switch_651045939750678262_gen
...
def A_switch_651045939750678262 (s₀ s₉ : State) : Prop := sorry

lemma switch_651045939750678262_abs_of_concrete {s₀ s₉ : State} :
  Spec switch_651045939750678262_concrete_of_code s₀ s₉ →
  Spec A_switch_651045939750678262 s₀ s₉ := by
  sorry
