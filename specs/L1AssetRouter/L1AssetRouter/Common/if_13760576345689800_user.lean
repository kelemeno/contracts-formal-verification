...
import generated.L1AssetRouter.L1AssetRouter.Common.if_13760576345689800_gen
...
def A_if_13760576345689800 (s₀ s₉ : State) : Prop := if_13760576345689800_concrete_of_code.1 s₀ s₉
