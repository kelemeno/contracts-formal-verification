...
def A_switch_2492635462891078030 (s₀ s₉ : State) : Prop :=
  switch_2492635462891078030_concrete_of_code.1 s₀ s₉
...
lemma switch_2492635462891078030_abs_of_concrete {s₀ s₉ : State} :
  ...
  unfold A_switch_2492635462891078030
  simpa [switch_2492635462891078030_concrete_of_code]
