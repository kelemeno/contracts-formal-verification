...
import generated.L1AssetRouter.L1AssetRouter.Common.switch_6234541684501094515_gen
...
def A_switch_6234541684501094515 (s₀ s₉ : State) : Prop :=
  switch_6234541684501094515_concrete_of_code.1 s₀ s₉

lemma switch_6234541684501094515_abs_of_concrete {s₀ s₉ : State} :
  Spec switch_6234541684501094515_concrete_of_code s₀ s₉ →
  Spec A_switch_6234541684501094515 s₀ s₉ := by
  intro h
  simpa [A_switch_6234541684501094515] using h
