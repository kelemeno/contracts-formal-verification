...
def A_fun__bridgehubDeposit_inner (var_request_mpos : Identifier) (var_chainId var_originalCaller var_value var_data_offset var_data_length var_nativeTokenVault : Literal) (s₀ s₉ : State) : Prop := sorry
