...
def A_abi_encode_bool_uint256_uint64_7917 (tail : Identifier) (value1 value2 : Literal) (s₀ s₉ : State) : Prop := abi_encode_bool_uint256_uint64_7917_concrete_of_code.1 tail value1 value2 s₀ s₉
...
lemma abi_encode_bool_uint256_uint64_7917_abs_of_concrete {s₀ s₉ : State} {tail value1 value2} :
  ...
  intro h
  simpa [A_abi_encode_bool_uint256_uint64_7917] using h
