...
import generated.AtomicFlowManager.AtomicFlowManager.abi_encode_array_bytes32_dyn_calldata_gen
...
def A_abi_encode_array_bytes32_dyn_calldata (end_clear_sanitised_hrafn : Identifier) (start length pos : Literal) (s₀ s₉ : State) : Prop := abi_encode_array_bytes32_dyn_calldata_concrete_of_code.1 end_clear_sanitised_hrafn start length pos s₀ s₉
