...
import generated.AtomicFlowManager.AtomicFlowManager.Common.if_7111651108353324005_gen
...
def A_if_7111651108353324005 (s₀ s₉ : State) : Prop := if_7111651108353324005_concrete_of_code.1 s₀ s₉
