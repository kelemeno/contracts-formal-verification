...
import generated.AtomicFlowManager.AtomicFlowManager.Common.if_2302834419921852506_gen
...
def A_if_2302834419921852506 (s₀ s₉ : State) : Prop := if_2302834419921852506_concrete_of_code.1 s₀ s₉
