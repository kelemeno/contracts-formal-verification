...
def ACond_for_6242390032430749259 (s₀ : State) : Literal := sorry 
def APost_for_6242390032430749259 (s₀ s₉ : State) : Prop := sorry
def ABody_for_6242390032430749259 (s₀ s₉ : State) : Prop := sorry
def AFor_for_6242390032430749259 (s₀ s₉ : State) : Prop := sorry
...
lemma AZero_for_6242390032430749259 : ∀ s₀, isOk s₀ → ACond_for_6242390032430749259 (👌 s₀) = 0 → AFor_for_6242390032430749259 s₀ s₀ := sorry
...
:= sorry
lemma AContinue_for_6242390032430749259 : ∀ s₀ s₂ s₄ s₅, isOk s₀ → isContinue s₂ → ¬ ACond_for_6242390032430749259 s₀ = 0 → ABody_for_6242390032430749259 s₀ s₂ → Spec APost_for_6242390032430749259 (🧟s₂) s₄ → Spec AFor_for_6242390032430749259 s₄ s₅ → AFor_for_6242390032430749259 s₀ s₅ := sorry
lemma ABreak_for_6242390032430749259 : ∀ s₀ s₂, isOk s₀ → isBreak s₂ → ¬ ACond_for_6242390032430749259 s₀ = 0 → ABody_for_6242390032430749259 s₀ s₂ → AFor_for_6242390032430749259 s₀ (🧟s₂) := sorry
lemma ALeave_for_6242390032430749259 : ∀ s₀ s₂, isOk s₀ → isLeave s₂ → ¬ ACond_for_6242390032430749259 s₀ = 0 → ABody_for_6242390032430749259 s₀ s₂ → AFor_for_6242390032430749259 s₀ s₂ := sorry
