...
def A_mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32 (dataSlot : Identifier) (slot key : Literal) (s₀ s₉ : State) : Prop :=
...
lemma mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32_abs_of_concrete {s₀ s₉ : State} {dataSlot slot key} :
  ...
  unfold mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32_concrete_of_code A_mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32
...
lemma mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32_isOk {dataSlot : Identifier} {slot key : Literal} {s₀ s₉ : State} (hnf : ¬ ❓ s₉)
    (h : A_mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32 dataSlot slot key s₀ s₉) : isOk s₉ := by
  subst h
...
lemma mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32_not_break {dataSlot : Identifier} {slot key : Literal} {s₀ s₉ : State} (hnf : ¬ ❓ s₉)
    (h : A_mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32 dataSlot slot key s₀ s₉) : ¬ isBreak s₉ :=
  fun hb => not_isOk_of_isBreak hb (mapping_index_access_mapping_bytes32_mapping_bytes32_enum_LegState_of_bytes32_isOk hnf h)
