...
def A_update_storage_value_offset_enum_LegState_to_enum_LegState  (slot : Literal) (s₀ s₉ : State) : Prop := update_storage_value_offset_enum_LegState_to_enum_LegState_concrete_of_code.1  slot s₀ s₉
...
lemma update_storage_value_offset_enum_LegState_to_enum_LegState_abs_of_concrete {s₀ s₉ : State} { slot} :
  ...
  intro h
  simpa [A_update_storage_value_offset_enum_LegState_to_enum_LegState] using h
