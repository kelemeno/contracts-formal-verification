...
def A_abi_decode_bytes32_7837 (value : Identifier)  (s₀ s₉ : State) : Prop := abi_decode_bytes32_7837_concrete_of_code.1 value s₀ s₉
...
lemma abi_decode_bytes32_7837_abs_of_concrete {s₀ s₉ : State} {value } :
  ...
  intro h
  simpa [A_abi_decode_bytes32_7837] using h
