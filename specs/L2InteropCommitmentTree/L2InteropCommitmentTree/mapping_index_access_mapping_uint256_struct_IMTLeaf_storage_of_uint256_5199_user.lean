...
def A_mapping_index_access_mapping_uint256_struct_IMTLeaf_storage_of_uint256_5199 (dataSlot : Identifier) (key : Literal) (s₀ s₉ : State) : Prop := mapping_index_access_mapping_uint256_struct_IMTLeaf_storage_of_uint256_5199_concrete_of_code.1 dataSlot key s₀ s₉
...
lemma mapping_index_access_mapping_uint256_struct_IMTLeaf_storage_of_uint256_5199_abs_of_concrete {s₀ s₉ : State} {dataSlot key} :
  ...
  intro h
  simpa [A_mapping_index_access_mapping_uint256_struct_IMTLeaf_storage_of_uint256_5199] using h
