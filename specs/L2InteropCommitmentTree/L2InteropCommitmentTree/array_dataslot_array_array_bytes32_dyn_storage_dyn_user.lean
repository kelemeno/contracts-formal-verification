...
def A_array_dataslot_array_array_bytes32_dyn_storage_dyn (data : Identifier) (ptr : Literal) (s₀ s₉ : State) : Prop := array_dataslot_array_array_bytes32_dyn_storage_dyn_concrete_of_code.1 data ptr s₀ s₉
...
lemma array_dataslot_array_array_bytes32_dyn_storage_dyn_abs_of_concrete {s₀ s₉ : State} {data ptr} :
  ...
  intro h
  simpa [A_array_dataslot_array_array_bytes32_dyn_storage_dyn] using h
