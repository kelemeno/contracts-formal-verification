...
def A_storage_array_index_access_bytes32_dyn_ptr_5214 (slot offset : Identifier) (index : Literal) (s₀ s₉ : State) : Prop := storage_array_index_access_bytes32_dyn_ptr_5214_concrete_of_code.1 slot offset index s₀ s₉
...
lemma storage_array_index_access_bytes32_dyn_ptr_5214_abs_of_concrete {s₀ s₉ : State} {slot offset index} :
  ...
  intro h
  simpa [A_storage_array_index_access_bytes32_dyn_ptr_5214] using h
