...
def A_if_1084122831851539501 (s₀ s₉ : State) : Prop :=
  ∃ s₁, Spec A_block_6787653505677561102 s₀ s₁ ∧
...
lemma if_1084122831851539501_abs_of_concrete {s₀ s₉ : State} :
  ...
  unfold if_1084122831851539501_concrete_of_code A_if_1084122831851539501
