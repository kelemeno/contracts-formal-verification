...
lemma block_3445626554890327039_sload {q : UInt256} {s₀ s₉ : State} (hok : isOk s₀)
    (hnf : ¬ ❓ s₉) (h : A_block_3445626554890327039 s₀ s₉) :
...
lemma block_3445626554890327039_config {s₀ s₉ : State} (hok : isOk s₀) (hnf : ¬ ❓ s₉)
    (hR : RangeInWindow s₀.evm) (hC : CachedInWindow s₀.evm)
    (h : A_block_3445626554890327039 s₀ s₉) :
