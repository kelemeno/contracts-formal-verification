...
lemma for_2268004712116198193_cond_abs_of_code {s₀ fuel} : eval fuel for_2268004712116198193_cond (s₀) = (s₀, ACond_for_2268004712116198193 (s₀)) := by
  ...
  simp [for_2268004712116198193_cond, Lit']
...
lemma ABody_for_2268004712116198193_writes_one_slot {s₀ s₉ : State} (hok : isOk s₀)
    (hok9 : isOk s₉) (h : ABody_for_2268004712116198193 s₀ s₉) :
  ...
  · have e1 : s₁ = rootGuardState s₀ := hg.2 hf
    ...
    rw [block_2896862189596047701_sload hs4 h5nf hq (Spec_ok_unfold hs4 h5nf h₅),
      block_5022472617119597648_sload hs3 h4nf (Spec_ok_unfold hs3 h4nf h₄),
      switch_8961670722464898128_sload hs2 h3nf (Spec_ok_unfold hs2 h3nf h₃),
