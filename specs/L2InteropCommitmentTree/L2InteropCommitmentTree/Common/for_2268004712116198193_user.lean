...
def APost_for_2268004712116198193 (s₀ s₉ : State) : Prop := for_2268004712116198193_post_concrete_of_code.1 s₀ s₉
def ABody_for_2268004712116198193 (s₀ s₉ : State) : Prop := for_2268004712116198193_body_concrete_of_code.1 s₀ s₉
def AFor_for_2268004712116198193 (s₀ s₉ : State) : Prop := True
...
lemma for_2268004712116198193_concrete_of_post_abs {s₀ s₉ : State} :
  ...
  intro h
  simpa [APost_for_2268004712116198193] using h
...
lemma for_2268004712116198193_concrete_of_body_abs {s₀ s₉ : State} :
  ...
  intro h
  simpa [ABody_for_2268004712116198193] using h
