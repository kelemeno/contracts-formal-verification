...
def A_block_8102603259148870207 (s₀ s₉ : State) : Prop :=
  ∃ s₁, Spec (A_storage_array_index_access_bytes32_dyn_ptr_5303 "_1" "_2" 2) s₀ s₁ ∧
    ∃ s₂, Spec (A_storage_array_index_access_bytes32_dyn_ptr "_3" "_4"
...
lemma block_8102603259148870207_abs_of_concrete {s₀ s₉ : State} :
  ...
  unfold block_8102603259148870207_concrete_of_code A_block_8102603259148870207
...
loop. -/
lemma block_8102603259148870207_frame {v : Identifier} {s₀ s₉ : State}
    (hok : isOk s₀) (hnf : ¬ ❓ s₉)
    (hv : v ∉ (["_1", "_2", "_3", "_4", "var_currentHash", "var_i"] : List Identifier))
    (h : A_block_8102603259148870207 s₀ s₉) : s₉[v]!! = s₀[v]!! := by
  ...
  have hok1 : isOk s₁ :=
    storage_array_index_access_bytes32_dyn_ptr_5303_isOk h1nf (Spec_ok_unfold hok h1nf hs₁)
  have hok2 : isOk s₂ :=
  ...
  rw [lookup_insert_of_ne hvi, lookup_insert_of_ne hcur,
    ...
    storage_array_index_access_bytes32_dyn_ptr_frame hok1 h2nf h3 h4
      (Spec_ok_unfold hok1 h2nf hs₂),
    storage_array_index_access_bytes32_dyn_ptr_5303_frame hok h1nf h1 h2
