...
def APost_for_5363593723278629209 (s₀ s₉ : State) : Prop := for_5363593723278629209_post_concrete_of_code.1 s₀ s₉
def ABody_for_5363593723278629209 (s₀ s₉ : State) : Prop := for_5363593723278629209_body_concrete_of_code.1 s₀ s₉
def AFor_for_5363593723278629209 (s₀ s₉ : State) : Prop := True
...
lemma for_5363593723278629209_concrete_of_post_abs {s₀ s₉ : State} :
  ...
  intro h
  simpa [APost_for_5363593723278629209] using h
...
lemma for_5363593723278629209_concrete_of_body_abs {s₀ s₉ : State} :
  ...
  intro h
  simpa [ABody_for_5363593723278629209] using h
