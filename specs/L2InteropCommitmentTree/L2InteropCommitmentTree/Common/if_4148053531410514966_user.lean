...
import generated.L2InteropCommitmentTree.L2InteropCommitmentTree.Common.if_4148053531410514966_gen
...
def A_if_4148053531410514966 (s₀ s₉ : State) : Prop := if_4148053531410514966_concrete_of_code.1 s₀ s₉
