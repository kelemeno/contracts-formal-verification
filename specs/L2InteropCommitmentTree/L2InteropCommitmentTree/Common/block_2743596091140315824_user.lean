...
lemma block_2743596091140315824_index {s₀ s₉ : State} (hok : isOk s₀) (hnf : ¬ ❓ s₉)
    (h : A_block_2743596091140315824 s₀ s₉) :
...
lemma block_2743596091140315824_frame {v : Identifier} {s₀ s₉ : State}
    (hok : isOk s₀) (hnf : ¬ ❓ s₉)
    (hv : v ∉ (["var_index", "var_maxNodeNumber", "split_expr_12", "_15", "_16", "_17",
      "_18"] : List Identifier))
    (h : A_block_2743596091140315824 s₀ s₉) : s₉[v]!! = s₀[v]!! := by
...
lemma block_2743596091140315824_sload {q : UInt256} {s₀ s₉ : State} (hok : isOk s₀)
    (hnf : ¬ ❓ s₉) (h : A_block_2743596091140315824 s₀ s₉) :
...
lemma block_2743596091140315824_config {s₀ s₉ : State} (hok : isOk s₀) (hnf : ¬ ❓ s₉)
