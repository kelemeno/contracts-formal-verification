...
import generated.L2InteropCommitmentTree.L2InteropCommitmentTree.Common.if_1966118315202180062_gen
...
def A_if_1966118315202180062 (s₀ s₉ : State) : Prop := if_1966118315202180062_concrete_of_code.1 s₀ s₉
