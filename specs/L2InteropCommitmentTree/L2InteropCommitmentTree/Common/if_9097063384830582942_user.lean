...
import generated.L2InteropCommitmentTree.L2InteropCommitmentTree.Common.if_9097063384830582942_gen
...
def A_if_9097063384830582942 (s₀ s₉ : State) : Prop := if_9097063384830582942_concrete_of_code.1 s₀ s₉
