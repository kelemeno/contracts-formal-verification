...
def A_abi_encode_uint256_uint256 (tail : Identifier) (value0 value1 : Literal) (s₀ s₉ : State) : Prop := abi_encode_uint256_uint256_concrete_of_code.1 tail value0 value1 s₀ s₉
