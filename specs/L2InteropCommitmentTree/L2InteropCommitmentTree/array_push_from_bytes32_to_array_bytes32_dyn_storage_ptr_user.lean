...
def A_array_push_from_bytes32_to_array_bytes32_dyn_storage_ptr  (array value0 : Literal) (s₀ s₉ : State) : Prop := array_push_from_bytes32_to_array_bytes32_dyn_storage_ptr_concrete_of_code.1  array value0 s₀ s₉
...
lemma array_push_from_bytes32_to_array_bytes32_dyn_storage_ptr_abs_of_concrete {s₀ s₉ : State} { array value0} :
  ...
  intro h
  simpa [A_array_push_from_bytes32_to_array_bytes32_dyn_storage_ptr] using h
