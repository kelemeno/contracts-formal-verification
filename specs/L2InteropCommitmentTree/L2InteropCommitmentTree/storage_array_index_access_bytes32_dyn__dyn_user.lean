...
def A_storage_array_index_access_bytes32_dyn__dyn (slot offset : Identifier) (array index : Literal) (s₀ s₉ : State) : Prop := storage_array_index_access_bytes32_dyn__dyn_concrete_of_code.1 slot offset array index s₀ s₉
...
lemma storage_array_index_access_bytes32_dyn__dyn_abs_of_concrete {s₀ s₉ : State} {slot offset array index} :
  ...
  intro h
  simpa [A_storage_array_index_access_bytes32_dyn__dyn] using h
