...
def A_storage_array_index_access_bytes32_dyn_ptr_5303 (slot offset : Identifier) (array : Literal) (s₀ s₉ : State) : Prop := storage_array_index_access_bytes32_dyn_ptr_5303_concrete_of_code.1 slot offset array s₀ s₉
...
lemma storage_array_index_access_bytes32_dyn_ptr_5303_abs_of_concrete {s₀ s₉ : State} {slot offset array} :
  ...
  intro h
  simpa [A_storage_array_index_access_bytes32_dyn_ptr_5303] using h
