...
import generated.L1Bridgehub.L1Bridgehub.abi_encode_address_address_gen
...
def abi_encode_address_address_evm
    (evm : EVM) (headStart value0 value1 : Literal) : EVM :=
  ((evm.mstore headStart (Fin.land value0 addressMask)).mstore (headStart + 32) (Fin.land value1 addressMask))

def A_abi_encode_address_address
    (tail : Identifier) (headStart value0 value1 : Literal) (s₀ s₉ : State) : Prop :=
