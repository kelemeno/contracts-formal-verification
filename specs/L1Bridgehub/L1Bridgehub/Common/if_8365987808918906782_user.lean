...
import generated.L1Bridgehub.L1Bridgehub.Common.if_8365987808918906782_gen
...
def A_if_8365987808918906782 (s₀ s₉ : State) : Prop := if_8365987808918906782_concrete_of_code.1 s₀ s₉
