...
import generated.L1Bridgehub.L1Bridgehub.abi_decode_address_gen
...
def A_abi_decode_address (value : Identifier)  (s₀ s₉ : State) : Prop := abi_decode_address_concrete_of_code.1 value s₀ s₉
