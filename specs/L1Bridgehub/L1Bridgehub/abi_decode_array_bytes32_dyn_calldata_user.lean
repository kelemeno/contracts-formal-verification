...
import generated.L1Bridgehub.L1Bridgehub.abi_decode_array_bytes32_dyn_calldata_gen
...
def A_abi_decode_array_bytes32_dyn_calldata (arrayPos length : Identifier) (offset end_clear_sanitised_hrafn : Literal) (s₀ s₉ : State) : Prop := abi_decode_array_bytes32_dyn_calldata_concrete_of_code.1 arrayPos length offset end_clear_sanitised_hrafn s₀ s₉
