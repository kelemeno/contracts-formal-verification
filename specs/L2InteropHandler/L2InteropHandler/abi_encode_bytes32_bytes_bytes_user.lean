...
def A_abi_encode_bytes32_bytes_bytes (tail : Identifier) (headStart value0 value1 value2 : Literal) (s₀ s₉ : State) : Prop := abi_encode_bytes32_bytes_bytes_concrete_of_code.1 tail headStart value0 value1 value2 s₀ s₉
