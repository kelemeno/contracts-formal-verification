...
def A_fun_parseEvmV1 (var_chainId var_addr : Identifier) (var_self_3868_mpos : Literal) (s₀ s₉ : State) : Prop := fun_parseEvmV1_concrete_of_code.1 var_chainId var_addr var_self_3868_mpos s₀ s₉
...
lemma fun_parseEvmV1_abs_of_concrete {s₀ s₉ : State} {var_chainId var_addr var_self_3868_mpos} :
  ...
  intro h
  simpa [A_fun_parseEvmV1] using h
