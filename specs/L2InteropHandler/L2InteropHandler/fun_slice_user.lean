...
def A_fun_slice (var__mpos : Identifier) (var_buffer_mpos var_start var_end : Literal) (s₀ s₉ : State) : Prop := fun_slice_concrete_of_code.1 var__mpos var_buffer_mpos var_start var_end s₀ s₉
