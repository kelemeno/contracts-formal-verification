...
def A_require_helper_error_ExecutingNotAllowed_bytes32_bytes_bytes  (condition expr expr_2409_mpos expr_2412_mpos : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma require_helper_error_ExecutingNotAllowed_bytes32_bytes_bytes_abs_of_concrete {s₀ s₉ : State} { condition expr expr_2409_mpos expr_2412_mpos} :
  ...
  unfold require_helper_error_ExecutingNotAllowed_bytes32_bytes_bytes_concrete_of_code A_require_helper_error_ExecutingNotAllowed_bytes32_bytes_bytes
  sorry
