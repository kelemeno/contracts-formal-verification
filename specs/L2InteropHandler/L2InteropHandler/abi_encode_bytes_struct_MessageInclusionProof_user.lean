...
def A_abi_encode_bytes_struct_MessageInclusionProof (tail : Identifier) (headStart value0 value1 : Literal) (s₀ s₉ : State) : Prop := abi_encode_bytes_struct_MessageInclusionProof_concrete_of_code.1 tail headStart value0 value1 s₀ s₉
...
lemma abi_encode_bytes_struct_MessageInclusionProof_abs_of_concrete {s₀ s₉ : State} {tail headStart value0 value1} :
  ...
  intro h
  simpa [A_abi_encode_bytes_struct_MessageInclusionProof] using h
