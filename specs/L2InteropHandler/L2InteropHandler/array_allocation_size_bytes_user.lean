...
import generated.L2InteropHandler.L2InteropHandler.array_allocation_size_bytes_gen
...
def A_array_allocation_size_bytes (size : Identifier) (length : Literal) (s₀ s₉ : State) : Prop := array_allocation_size_bytes_concrete_of_code.1 size length s₀ s₉
