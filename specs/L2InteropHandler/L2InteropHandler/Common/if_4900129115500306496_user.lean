...
import generated.L2InteropHandler.L2InteropHandler.Common.if_4900129115500306496_gen
...
def A_if_4900129115500306496 (s₀ s₉ : State) : Prop := if_4900129115500306496_concrete_of_code.1 s₀ s₉
