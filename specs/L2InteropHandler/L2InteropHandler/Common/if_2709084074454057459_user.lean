...
import generated.L2InteropHandler.L2InteropHandler.Common.if_2709084074454057459_gen
...
def A_if_2709084074454057459 (s₀ s₉ : State) : Prop := if_2709084074454057459_concrete_of_code.1 s₀ s₉
