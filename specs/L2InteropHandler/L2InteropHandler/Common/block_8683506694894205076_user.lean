...
import generated.L2InteropHandler.L2InteropHandler.Common.block_8683506694894205076_gen
...
def A_block_8683506694894205076 (s₀ s₉ : State) : Prop := block_8683506694894205076_concrete_of_code.1 s₀ s₉
