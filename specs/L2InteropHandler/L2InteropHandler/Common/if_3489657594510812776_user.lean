...
import generated.L2InteropHandler.L2InteropHandler.Common.if_3489657594510812776_gen
...
def A_if_3489657594510812776 (s₀ s₉ : State) : Prop := if_3489657594510812776_concrete_of_code.1 s₀ s₉
