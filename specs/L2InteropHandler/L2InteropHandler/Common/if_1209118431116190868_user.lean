...
import generated.L2InteropHandler.L2InteropHandler.Common.if_1209118431116190868_gen
...
def A_if_1209118431116190868 (s₀ s₉ : State) : Prop := if_1209118431116190868_concrete_of_code.1 s₀ s₉
