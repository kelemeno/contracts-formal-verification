...
import generated.L2InteropHandler.L2InteropHandler.Common.if_3995168818704772226_gen
...
def A_if_3995168818704772226 (s₀ s₉ : State) : Prop := if_3995168818704772226_concrete_of_code.1 s₀ s₉
