...
import generated.L2InteropHandler.L2InteropHandler.Common.if_5778481415897612946_gen
...
def A_if_5778481415897612946 (s₀ s₉ : State) : Prop := if_5778481415897612946_concrete_of_code.1 s₀ s₉
