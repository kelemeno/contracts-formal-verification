...
import generated.L2InteropHandler.L2InteropHandler.Common.if_1366110598910321239_gen
...
def A_if_1366110598910321239 (s₀ s₉ : State) : Prop := if_1366110598910321239_concrete_of_code.1 s₀ s₉
