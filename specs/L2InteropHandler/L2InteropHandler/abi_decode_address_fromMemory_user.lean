...
import generated.L2InteropHandler.L2InteropHandler.abi_decode_address_fromMemory_gen
...
def A_abi_decode_address_fromMemory (value : Identifier) (offset : Literal) (s₀ s₉ : State) : Prop := abi_decode_address_fromMemory_concrete_of_code.1 value offset s₀ s₉
