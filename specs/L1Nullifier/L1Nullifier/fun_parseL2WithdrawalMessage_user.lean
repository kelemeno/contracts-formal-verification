...
def A_fun_parseL2WithdrawalMessage (var_assetId var_transferData_1336_mpos : Identifier) (var_chainId var_l2ToL1message_1331_mpos : Literal) (s₀ s₉ : State) : Prop := fun_parseL2WithdrawalMessage_concrete_of_code.1 var_assetId var_transferData_1336_mpos var_chainId var_l2ToL1message_1331_mpos s₀ s₉
