...
def A_fun_encodeTxDataHash_5462 (var_txDataHash : Identifier) (var_encodingVersion var_originalCaller var_assetId var_nativeTokenVault var_transferData_5382_mpos : Literal) (s₀ s₉ : State) : Prop := fun_encodeTxDataHash_5462_concrete_of_code.1 var_txDataHash var_encodingVersion var_originalCaller var_assetId var_nativeTokenVault var_transferData_5382_mpos s₀ s₉
