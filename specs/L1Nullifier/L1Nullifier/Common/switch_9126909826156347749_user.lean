...
import generated.L1Nullifier.L1Nullifier.Common.switch_9126909826156347749_gen
...
def A_switch_9126909826156347749 (s₀ s₉ : State) : Prop := switch_9126909826156347749_concrete_of_code.1 s₀ s₉

lemma switch_9126909826156347749_abs_of_concrete {s₀ s₉ : State} :
  Spec switch_9126909826156347749_concrete_of_code s₀ s₉ →
  Spec A_switch_9126909826156347749 s₀ s₉ := by
  intro h
  simpa [A_switch_9126909826156347749] using h
