...
import generated.L1Nullifier.L1Nullifier.Common.if_4307119837691313886_gen
...
def A_if_4307119837691313886 (s₀ s₉ : State) : Prop :=
  if_4307119837691313886_concrete_of_code.1 s₀ s₉
