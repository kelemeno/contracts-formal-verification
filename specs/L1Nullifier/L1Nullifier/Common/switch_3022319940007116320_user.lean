...
import generated.L1Nullifier.L1Nullifier.Common.switch_3022319940007116320_gen
...
def A_switch_3022319940007116320 (s₀ s₉ : State) : Prop := switch_3022319940007116320_concrete_of_code.1 s₀ s₉

lemma switch_3022319940007116320_abs_of_concrete {s₀ s₉ : State} :
  Spec switch_3022319940007116320_concrete_of_code s₀ s₉ →
  Spec A_switch_3022319940007116320 s₀ s₉ := by
  intro h
  simpa [A_switch_3022319940007116320] using h
