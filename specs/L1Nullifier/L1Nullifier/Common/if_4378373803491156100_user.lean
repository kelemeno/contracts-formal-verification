...
import generated.L1Nullifier.L1Nullifier.Common.if_4378373803491156100_gen
...
def A_if_4378373803491156100 (s₀ s₉ : State) : Prop :=
  if_4378373803491156100_concrete_of_code.1 s₀ s₉
