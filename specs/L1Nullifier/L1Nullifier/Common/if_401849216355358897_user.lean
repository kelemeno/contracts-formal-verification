...
import generated.L1Nullifier.L1Nullifier.Common.if_401849216355358897_gen
...
def A_if_401849216355358897 (s₀ s₉ : State) : Prop :=
  if_401849216355358897_concrete_of_code.1 s₀ s₉
