...
import generated.L1Nullifier.L1Nullifier.Common.switch_7588491999449702693_gen
...
def A_switch_7588491999449702693 (s₀ s₉ : State) : Prop := True

lemma switch_7588491999449702693_abs_of_concrete {s₀ s₉ : State} :
  Spec switch_7588491999449702693_concrete_of_code s₀ s₉ →
  Spec A_switch_7588491999449702693 s₀ s₉ := by
  unfold A_switch_7588491999449702693
