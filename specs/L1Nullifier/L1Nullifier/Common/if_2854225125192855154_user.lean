...
import generated.L1Nullifier.L1Nullifier.Common.if_2854225125192855154_gen
...
def A_if_2854225125192855154 (s₀ s₉ : State) : Prop := True

lemma if_2854225125192855154_abs_of_concrete {s₀ s₉ : State} :
  Spec if_2854225125192855154_concrete_of_code s₀ s₉ →
  Spec A_if_2854225125192855154 s₀ s₉ := by
  unfold A_if_2854225125192855154
