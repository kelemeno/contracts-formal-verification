...
def A_require_helper_error_WithdrawalAlreadyFinalized  (condition : Literal) (s₀ s₉ : State) : Prop := require_helper_error_WithdrawalAlreadyFinalized_concrete_of_code.1  condition s₀ s₉
