...
def A_abi_encode_array_bytes32_dyn (end_clear_sanitised_hrafn : Identifier) (value pos : Literal) (s₀ s₉ : State) : Prop :=
  abi_encode_array_bytes32_dyn_concrete_of_code.1 end_clear_sanitised_hrafn value pos s₀ s₉
