...
def A_mapping_index_access_mapping_uint256_mapping_address_uint256_of_uint256 (dataSlot : Identifier) (slot key : Literal) (s₀ s₉ : State) : Prop := mapping_index_access_mapping_uint256_mapping_address_uint256_of_uint256_concrete_of_code.1 dataSlot slot key s₀ s₉
...
lemma mapping_index_access_mapping_uint256_mapping_address_uint256_of_uint256_abs_of_concrete {s₀ s₉ : State} {dataSlot slot key} :
  ...
  intro h
  simpa [A_mapping_index_access_mapping_uint256_mapping_address_uint256_of_uint256] using h
