...
def A_fun_encodeBridgeMintData_17779 (var_mpos : Identifier) (var__remoteReceiver var_amount var_erc20Metadata_mpos : Literal) (s₀ s₉ : State) : Prop := fun_encodeBridgeMintData_17779_concrete_of_code.1 var_mpos var__remoteReceiver var_amount var_erc20Metadata_mpos s₀ s₉
...
lemma fun_encodeBridgeMintData_17779_abs_of_concrete {s₀ s₉ : State} {var_mpos var__remoteReceiver var_amount var_erc20Metadata_mpos} :
  ...
  intro h
  simpa [A_fun_encodeBridgeMintData_17779] using h
