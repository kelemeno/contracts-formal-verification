...
def A_abi_encode_bytes32_address (tail : Identifier) (value0 value1 : Literal) (s₀ s₉ : State) : Prop := abi_encode_bytes32_address_concrete_of_code.1 tail value0 value1 s₀ s₉
...
lemma abi_encode_bytes32_address_abs_of_concrete {s₀ s₉ : State} {tail value0 value1} :
  ...
  intro h
  simpa [A_abi_encode_bytes32_address] using h
