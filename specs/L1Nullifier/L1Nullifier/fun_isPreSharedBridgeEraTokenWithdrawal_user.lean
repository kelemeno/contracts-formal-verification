...
def A_fun_isPreSharedBridgeEraTokenWithdrawal (var_ : Identifier) (var_chainId var__l2BatchNumber : Literal) (s₀ s₉ : State) : Prop := fun_isPreSharedBridgeEraTokenWithdrawal_concrete_of_code.1 var_ var_chainId var__l2BatchNumber s₀ s₉
