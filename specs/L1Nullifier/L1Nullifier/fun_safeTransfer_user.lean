...
def A_fun_safeTransfer  (var_token_address var_to var_value : Literal) (s₀ s₉ : State) : Prop := fun_safeTransfer_concrete_of_code.1  var_token_address var_to var_value s₀ s₉
