...
def A_mapping_index_access_mapping_address_uint256_of_address (dataSlot : Identifier) (slot key : Literal) (s₀ s₉ : State) : Prop := mapping_index_access_mapping_address_uint256_of_address_concrete_of_code.1 dataSlot slot key s₀ s₉
...
lemma mapping_index_access_mapping_address_uint256_of_address_abs_of_concrete {s₀ s₉ : State} {dataSlot slot key} :
  ...
  intro h
  simpa [A_mapping_index_access_mapping_address_uint256_of_address] using h
