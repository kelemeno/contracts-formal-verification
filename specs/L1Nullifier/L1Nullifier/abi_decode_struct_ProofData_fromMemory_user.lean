...
def A_abi_decode_struct_ProofData_fromMemory (value0 : Identifier) (headStart dataEnd : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma abi_decode_struct_ProofData_fromMemory_abs_of_concrete {s₀ s₉ : State} {value0 headStart dataEnd} :
  ...
  unfold abi_decode_struct_ProofData_fromMemory_concrete_of_code A_abi_decode_struct_ProofData_fromMemory
  sorry
