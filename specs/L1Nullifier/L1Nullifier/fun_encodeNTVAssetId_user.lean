...
def A_fun_encodeNTVAssetId (var : Identifier) (var_chainId var_tokenAddress : Literal) (s₀ s₉ : State) : Prop := fun_encodeNTVAssetId_concrete_of_code.1 var var_chainId var_tokenAddress s₀ s₉
