...
def A_require_helper_error_AddressAlreadySet_address  (condition expr : Literal) (s₀ s₉ : State) : Prop := True
...
lemma require_helper_error_AddressAlreadySet_address_abs_of_concrete {s₀ s₉ : State} { condition expr} :
  ...
  unfold A_require_helper_error_AddressAlreadySet_address
