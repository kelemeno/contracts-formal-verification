...
def A_abi_decode_array_bytes32_dyn (array : Identifier) (offset end_clear_sanitised_hrafn : Literal) (s₀ s₉ : State) : Prop := abi_decode_array_bytes32_dyn_concrete_of_code.1 array offset end_clear_sanitised_hrafn s₀ s₉
