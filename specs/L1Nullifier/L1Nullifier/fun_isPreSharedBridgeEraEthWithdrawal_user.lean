...
def A_fun_isPreSharedBridgeEraEthWithdrawal (var : Identifier) (var_chainId var_l2BatchNumber : Literal) (s₀ s₉ : State) : Prop := fun_isPreSharedBridgeEraEthWithdrawal_concrete_of_code.1 var var_chainId var_l2BatchNumber s₀ s₉
