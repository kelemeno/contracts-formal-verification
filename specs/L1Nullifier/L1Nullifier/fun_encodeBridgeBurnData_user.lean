...
def A_fun_encodeBridgeBurnData (var_mpos : Identifier) (var_amount : Literal) (s₀ s₉ : State) : Prop := fun_encodeBridgeBurnData_concrete_of_code.1 var_mpos var_amount s₀ s₉
