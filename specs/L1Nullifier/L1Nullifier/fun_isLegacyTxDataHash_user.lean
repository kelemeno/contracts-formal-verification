...
def A_fun_isLegacyTxDataHash (var_isLegacyTxDataHash : Identifier) (var_depositSender var_assetId var__transferData_mpos var_expectedTxDataHash : Literal) (s₀ s₉ : State) : Prop := fun_isLegacyTxDataHash_concrete_of_code.1 var_isLegacyTxDataHash var_depositSender var_assetId var__transferData_mpos var_expectedTxDataHash s₀ s₉
