...
def A_abi_encode_address_bytes32_bytes (tail : Identifier) (headStart value0 value1 value2 : Literal) (s₀ s₉ : State) : Prop := True
...
lemma abi_encode_address_bytes32_bytes_abs_of_concrete {s₀ s₉ : State} {tail headStart value0 value1 value2} :
  ...
  unfold A_abi_encode_address_bytes32_bytes
