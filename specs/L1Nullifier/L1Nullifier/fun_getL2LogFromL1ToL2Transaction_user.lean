...
def A_fun_getL2LogFromL1ToL2Transaction (var_l2Log_mpos : Identifier) (var__l2TxNumberInBatch var_l2TxHash var_status : Literal) (s₀ s₉ : State) : Prop := fun_getL2LogFromL1ToL2Transaction_concrete_of_code.1 var_l2Log_mpos var__l2TxNumberInBatch var_l2TxHash var_status s₀ s₉
