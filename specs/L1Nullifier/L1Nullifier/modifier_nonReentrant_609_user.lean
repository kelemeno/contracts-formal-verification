...
def A_modifier_nonReentrant_609  (var_confirmTransferResultData_mpos : Literal) (s₀ s₉ : State) : Prop := modifier_nonReentrant_609_concrete_of_code.1  var_confirmTransferResultData_mpos s₀ s₉
...
lemma modifier_nonReentrant_609_abs_of_concrete {s₀ s₉ : State} { var_confirmTransferResultData_mpos} :
  ...
  intro h
  simpa [A_modifier_nonReentrant_609] using h
