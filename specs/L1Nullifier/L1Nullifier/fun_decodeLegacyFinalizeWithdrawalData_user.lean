...
def A_fun_decodeLegacyFinalizeWithdrawalData (var_functionSignature var_l1Token var_transferData_mpos : Identifier) (var_l1ChainId var__l2ToL1message_mpos : Literal) (s₀ s₉ : State) : Prop := fun_decodeLegacyFinalizeWithdrawalData_concrete_of_code.1 var_functionSignature var_l1Token var_transferData_mpos var_l1ChainId var__l2ToL1message_mpos s₀ s₉
