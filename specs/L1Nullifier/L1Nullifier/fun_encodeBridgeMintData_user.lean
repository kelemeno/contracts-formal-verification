...
def A_fun_encodeBridgeMintData (var_mpos : Identifier) (var_remoteReceiver var_originToken var_amount var_erc20Metadata_mpos : Literal) (s₀ s₉ : State) : Prop := fun_encodeBridgeMintData_concrete_of_code.1 var_mpos var_remoteReceiver var_originToken var_amount var_erc20Metadata_mpos s₀ s₉
