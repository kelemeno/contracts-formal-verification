...
def A_fun_decodeBridgeBurnData (var_amount var_receiver var_maybeTokenAddress : Identifier) (var_data_mpos : Literal) (s₀ s₉ : State) : Prop := fun_decodeBridgeBurnData_concrete_of_code.1 var_amount var_receiver var_maybeTokenAddress var_data_mpos s₀ s₉
