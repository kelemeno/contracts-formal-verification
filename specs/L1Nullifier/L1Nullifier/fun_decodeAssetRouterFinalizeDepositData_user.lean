...
def A_fun_decodeAssetRouterFinalizeDepositData (var_functionSignature var_messageSourceChainId var_assetId var_transferData_5881_mpos : Identifier) (var_l2ToL1message_mpos : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma fun_decodeAssetRouterFinalizeDepositData_abs_of_concrete {s₀ s₉ : State} {var_functionSignature var_messageSourceChainId var_assetId var_transferData_5881_mpos var_l2ToL1message_mpos} :
  ...
  unfold fun_decodeAssetRouterFinalizeDepositData_concrete_of_code A_fun_decodeAssetRouterFinalizeDepositData
  sorry
