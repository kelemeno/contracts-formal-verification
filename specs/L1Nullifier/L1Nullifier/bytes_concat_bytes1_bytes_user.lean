...
def A_bytes_concat_bytes1_bytes (outPtr : Identifier) (param param_1 : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma bytes_concat_bytes1_bytes_abs_of_concrete {s₀ s₉ : State} {outPtr param param_1} :
  ...
  unfold bytes_concat_bytes1_bytes_concrete_of_code A_bytes_concat_bytes1_bytes
  sorry
