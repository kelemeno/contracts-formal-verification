...
def A_bytes_concat_bytes1_bytes (outPtr : Identifier) (param param_1 : Literal) (s₀ s₉ : State) : Prop := bytes_concat_bytes1_bytes_concrete_of_code.1 outPtr param param_1 s₀ s₉
