...
/-- abi_decode_uint256_17645 loads a uint256 from calldata at offset 132. -/
def A_abi_decode_uint256_17645 (value : Identifier) (s₀ s₉ : State) : Prop :=
  s₉ = s₀⟦value ↦ s₀.evm.calldataload 132⟧
...
lemma abi_decode_uint256_17645_abs_of_concrete {{s₀ s₉ : State}} {{value}} :
  ...
  unfold abi_decode_uint256_17645_concrete_of_code A_abi_decode_uint256_17645
