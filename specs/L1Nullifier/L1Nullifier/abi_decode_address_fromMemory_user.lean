...
def A_abi_decode_address_fromMemory (value0 : Identifier) (headStart dataEnd : Literal) (s₀ s₉ : State) : Prop := abi_decode_address_fromMemory_concrete_of_code.1 value0 headStart dataEnd s₀ s₉
