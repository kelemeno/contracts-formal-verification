...
def A_abi_encode_uint256_enum_TxStatus_address_bytes32_bytes_17677 (tail : Identifier) (headStart value0 value2 value3 value4 : Literal) (s₀ s₉ : State) : Prop := abi_encode_uint256_enum_TxStatus_address_bytes32_bytes_17677_concrete_of_code.1 tail headStart value0 value2 value3 value4 s₀ s₉
