...
import generated.L1Nullifier.L1Nullifier.allocate_memory_gen
...
def A_allocate_memory (memPtr : Identifier)  (s₀ s₉ : State) : Prop :=
  allocate_memory_concrete_of_code.1 memPtr s₀ s₉
