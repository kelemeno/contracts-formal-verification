...
def A_require_helper_error_L2WithdrawalMessageWrongLength_uint256  (condition expr : Literal) (s₀ s₉ : State) : Prop := require_helper_error_L2WithdrawalMessageWrongLength_uint256_concrete_of_code.1  condition expr s₀ s₉
...
lemma require_helper_error_L2WithdrawalMessageWrongLength_uint256_abs_of_concrete {s₀ s₉ : State} { condition expr} :
  ...
  intro h
  simpa [A_require_helper_error_L2WithdrawalMessageWrongLength_uint256] using h
