...
def A_abi_decode_available_length_array_bytes32_dyn (array : Identifier) (offset length end_clear_sanitised_hrafn : Literal) (s₀ s₉ : State) : Prop := True
...
lemma abi_decode_available_length_array_bytes32_dyn_abs_of_concrete {s₀ s₉ : State} {array offset length end_clear_sanitised_hrafn} :
  ...
  unfold A_abi_decode_available_length_array_bytes32_dyn
