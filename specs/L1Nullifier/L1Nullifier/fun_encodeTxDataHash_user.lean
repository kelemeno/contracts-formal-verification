...
def A_fun_encodeTxDataHash (var_txDataHash : Identifier) (var_originalCaller var_assetId var_nativeTokenVault var_transferData_mpos : Literal) (s₀ s₉ : State) : Prop := fun_encodeTxDataHash_concrete_of_code.1 var_txDataHash var_originalCaller var_assetId var_nativeTokenVault var_transferData_mpos s₀ s₉
