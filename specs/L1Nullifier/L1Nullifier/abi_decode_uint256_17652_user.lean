...
/-- abi_decode_uint256_17652 loads a uint256 from calldata at offset 100. -/
def A_abi_decode_uint256_17652 (value : Identifier) (s₀ s₉ : State) : Prop :=
  s₉ = s₀⟦value ↦ s₀.evm.calldataload 100⟧
...
lemma abi_decode_uint256_17652_abs_of_concrete {{s₀ s₉ : State}} {{value}} :
  ...
  unfold abi_decode_uint256_17652_concrete_of_code A_abi_decode_uint256_17652
