...
def A_fun_decodeBaseTokenFinalizeWithdrawalData (var_functionSignature var_l1Receiver var_amount : Identifier) (var_l2ToL1message_5663_mpos : Literal) (s₀ s₉ : State) : Prop := fun_decodeBaseTokenFinalizeWithdrawalData_concrete_of_code.1 var_functionSignature var_l1Receiver var_amount var_l2ToL1message_5663_mpos s₀ s₉
