...
def A_fun_decodeBaseTokenFinalizeWithdrawalData (var_functionSignature var_l1Receiver var_amount : Identifier) (var_l2ToL1message_5663_mpos : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma fun_decodeBaseTokenFinalizeWithdrawalData_abs_of_concrete {s₀ s₉ : State} {var_functionSignature var_l1Receiver var_amount var_l2ToL1message_5663_mpos} :
  ...
  unfold fun_decodeBaseTokenFinalizeWithdrawalData_concrete_of_code A_fun_decodeBaseTokenFinalizeWithdrawalData
  sorry
