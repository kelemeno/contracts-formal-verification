...
def A_fun_initialize_inner  (var_owner var_eraPostDiamondUpgradeFirstBatch var_eraPostLegacyBridgeUpgradeFirstBatch var_eraLegacyBridgeLastDepositBatch var_eraLegacyBridgeLastDepositTxNumber : Literal) (s₀ s₉ : State) : Prop := fun_initialize_inner_concrete_of_code.1  var_owner var_eraPostDiamondUpgradeFirstBatch var_eraPostLegacyBridgeUpgradeFirstBatch var_eraLegacyBridgeLastDepositBatch var_eraLegacyBridgeLastDepositTxNumber s₀ s₉
