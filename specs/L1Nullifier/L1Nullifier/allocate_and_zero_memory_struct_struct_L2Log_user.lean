...
def A_allocate_and_zero_memory_struct_struct_L2Log (memPtr : Identifier)  (s₀ s₉ : State) : Prop := sorry
...
lemma allocate_and_zero_memory_struct_struct_L2Log_abs_of_concrete {s₀ s₉ : State} {memPtr } :
  ...
  unfold allocate_and_zero_memory_struct_struct_L2Log_concrete_of_code A_allocate_and_zero_memory_struct_struct_L2Log
  sorry
