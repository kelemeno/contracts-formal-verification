...
def A_abi_encode_uint256_enum_TxStatus_address_bytes32_bytes (tail : Identifier) (headStart value0 value1 value2 value3 value4 : Literal) (s₀ s₉ : State) : Prop :=
  abi_encode_uint256_enum_TxStatus_address_bytes32_bytes_concrete_of_code.1 tail headStart value0 value1 value2 value3 value4 s₀ s₉
