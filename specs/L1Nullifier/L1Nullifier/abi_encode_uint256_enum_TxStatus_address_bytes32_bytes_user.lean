...
def A_abi_encode_uint256_enum_TxStatus_address_bytes32_bytes (tail : Identifier) (headStart value0 value1 value2 value3 value4 : Literal) (s₀ s₉ : State) : Prop := True
...
lemma abi_encode_uint256_enum_TxStatus_address_bytes32_bytes_abs_of_concrete {s₀ s₉ : State} {tail headStart value0 value1 value2 value3 value4} :
  ...
  unfold A_abi_encode_uint256_enum_TxStatus_address_bytes32_bytes
