...
def A_fun_l2MessageToLog (var_6142_mpos : Identifier) (var_message_mpos : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma fun_l2MessageToLog_abs_of_concrete {s₀ s₉ : State} {var_6142_mpos var_message_mpos} :
  ...
  unfold fun_l2MessageToLog_concrete_of_code A_fun_l2MessageToLog
  sorry
