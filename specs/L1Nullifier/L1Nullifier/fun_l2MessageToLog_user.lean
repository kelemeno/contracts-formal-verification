...
def A_fun_l2MessageToLog (var_6142_mpos : Identifier) (var_message_mpos : Literal) (s₀ s₉ : State) : Prop := fun_l2MessageToLog_concrete_of_code.1 var_6142_mpos var_message_mpos s₀ s₉
