...
def A_validator_revert_contract_IL1ERC20Bridge  (value : Literal) (s₀ s₉ : State) : Prop := sorry
...
lemma validator_revert_contract_IL1ERC20Bridge_abs_of_concrete {s₀ s₉ : State} { value} :
  ...
  unfold validator_revert_contract_IL1ERC20Bridge_concrete_of_code A_validator_revert_contract_IL1ERC20Bridge
  sorry
