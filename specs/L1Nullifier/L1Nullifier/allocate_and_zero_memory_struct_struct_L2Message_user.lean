...
def A_allocate_and_zero_memory_struct_struct_L2Message (memPtr : Identifier)  (s₀ s₉ : State) : Prop := allocate_and_zero_memory_struct_struct_L2Message_concrete_of_code.1 memPtr s₀ s₉
